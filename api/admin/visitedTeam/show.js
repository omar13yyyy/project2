...
async function show(req,res,next){
    ...
    let result = await commitsql(`SELECT  "sendTeam".id,request.title,"sendTeam".requestid,"sendTeam"."fromDate","sendTeam"."toDate" FROM "sendTeam" JOIN request ON "sendTeam".requestId = request.id where done = false AND "teamId"=$1  `,[1]);
